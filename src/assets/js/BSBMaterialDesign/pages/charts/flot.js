...
$(function () {
    ...
    plots.push(multipleAxisPlot);
    //= ===================================================================================================

    // BAR CHART ==========================================================================================
    var barChartData = [];
    for (var ii = 0; ii <= 10; ii += 1) {
        barChartData.push([ii, parseInt(Math.random() * 30)]);
    }

    var barChartPlot = $.plot("#bar_chart", [barChartData], {
        series: {
            stack: 0,
            lines: {
                show: false,
    ...
    plots.push(barChartPlot);
    //= ===================================================================================================

    // PIE CHART ==========================================================================================
    var pieChartData = [];
    var pieChartSeries = 4;
    var pieChartColors = ["#E91E63", "#03A9F4", "#FFC107", "#009688"];
    var pieChartDatas = [45, 17, 28, 10];

    for (var ij = 0; ij < pieChartSeries; ij++) {
        pieChartData[ij] = {
            label: "Serie - " + (ij + 1),
            data: pieChartDatas[ij],
            color: pieChartColors[ij],
        };
    }
    var pieChartPlot = $.plot("#pie_chart", pieChartData, {
        series: {
            pie: {
                show: true,
                radius: 1,
