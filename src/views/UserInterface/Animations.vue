...
<template>
    <div class="container-fluid">
        <header-content title="Animations" />
        <component-card
            :header="{
                class: '',
        ...
        >
            <template v-slot:body>
                <img
                    src="static/images/animation-bg.jpg"
...
<script>
export default {
    name: "UserInterfaceAnimations",
    data: function () {
        return {
            description:
                "Pure css animations - <a href='https://daneden.github.io/animate.css/' target='_blank'>daneden.github.io/animate.css</a>",
        };
    },
    mounted: function () {},
    methods: {},
